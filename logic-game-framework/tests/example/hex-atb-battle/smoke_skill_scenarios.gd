...
##
## 扫 `addons/logic-game-framework/tests/example/hex-atb-battle/skill_scenarios/`
## 下除基础设施文件外的所有 *.gd:
##   - 加载脚本
...
const SCENARIOS_DIR := "res://addons/logic-game-framework/tests/example/hex-atb-battle/skill_scenarios/"
