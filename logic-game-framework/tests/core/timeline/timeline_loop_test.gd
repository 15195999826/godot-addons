...
func _init() -> void:
	...
	TestFramework.register_test("serialize includes loops_completed", _test_serialize_loops)
...
func _test_loop_carry_over() -> void:
	...
	TestFramework.assert_true(instance.is_executing())
	TestFramework.assert_equal(1, instance.serialize()["loops_completed"])
...
func _test_loop_cadence_no_drift() -> void:
	...
	TestFramework.assert_equal(3, instance.serialize()["loops_completed"])
...
func _test_serialize_loops() -> void:
	...
	TestFramework.assert_true(s.has("loops_completed"))
	TestFramework.assert_equal(2, s["loops_completed"])
