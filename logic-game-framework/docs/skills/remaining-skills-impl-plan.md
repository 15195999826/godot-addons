...
| 05 | [`phase-05-summon-totem-spike.md`](remaining-skills-impl-plan/phase-05-summon-totem-spike.md) | Summon Totem：spawn/remove/replay/TTL TDD spike | ⬜ spike/TDD 门 |
...
6. Phase 05 不直接实现图腾技能，先按文档写红测试和 spike 结论。
...
| Summon Totem | TDD spike 验证框架原语 → 绿后再出正式 impl align 方案 | 战斗中途 add/remove actor + recording 完整性未知 |
