## ShieldSummary - 账本上的护盾摘要
##
## ActorVisualState.shields 数组的元素。来源:项目翻译员翻译事件流产生
## VisualShieldStateAction,VisualUpdater 应用到 actor.shields 数组。
##
...
func duplicate() -> ShieldSummary:
	var copy := ShieldSummary.new()
	copy.id = id
